...
#    @label.setTraceAll()
  ...
  getDefaultMessage1: ()->
    ...
    encoding = Hy.Network.NetworkService.getAddressEncoding()
    ...
    if encoding?
      content += "\nAdditional players? Visit #{Hy.Config.Rendezvous.URLDisplayName} and enter \"#{encoding}\""
    else
      content += "\nConnect to WiFi so others can play also!"
...
#    return "1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 1234567890 "
    ...
    if (encoding = Hy.Network.NetworkService.getAddressEncoding())?
      content += "Party mode players: Enter code \"#{encoding}\" at #{Hy.Config.Rendezvous.URLDisplayName} on an iOS device"
    else
      content = "Connect to WiFi for Party mode so your friends can play!"
